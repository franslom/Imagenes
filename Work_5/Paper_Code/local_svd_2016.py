...
if args.output is not None:
	for i in xrange(f.shape[0]):
		...
		#franci
		if cdnet_count < 10:
			name_out = ruta + "output_code/in00000" + str(cdnet_count) + ".jpg"
		elif cdnet_count < 100:
			name_out = ruta + "output_code/in0000" + str(cdnet_count)  + ".jpg";
		elif cdnet_count < 1000:
			name_out = ruta + "output_code/in000" + str(cdnet_count)  + ".jpg"
		else:
			name_out = ruta + "output_code/in00" + str(cdnet_count)  + ".jpg"

		cv2.imwrite(name_out, mrf * 255)
		cdnet_count+=1
